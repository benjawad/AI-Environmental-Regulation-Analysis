...
from app.services.legal_register.views import *
from . import views
...
urlpatterns = [
    ...
    path('legal-register/', views.legal_register, name='legal_register'),
    ...
    path("commitment/save_results/", views.save_commitment_results_view, name="save_commitment_results"),
    path("registers/<int:pk>/download/", views.download_generated_register_view, name="download_generated_register"),
    path("commitment/list_db/", views.list_commitment_registers_view, name="commitment_list_db"),
    path("commitment/upload/", views.upload_commitment_register_view, name="commitment_upload"),
    path("commitment/load/<int:pk>/", views.load_commitment_register_view, name="commitment_load"),
    ...
    path("bo_scrape/sources/", list_scrape_sources, name="list_scrape_sources"),
    path("bo_scrape/sources/", list_scrape_sources, name="list_scrape_sources"),
    ...
    path("bo_parse/list_db_docs/", list_db_docs, name="list_db_docs"),
    path("old_registers/upload/", upload_old_register, name="upload_old_register"),\
    ...
    path("llm/save_structured/", save_structured_view, name="save_structured"),
